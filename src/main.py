...
#this code is checking titles of applications and using chatgpt api evaluates whether it is useful or not
#todo move this to class in future when you create logic class
